...
def compute_mfg_obj_functional(NF, obstacle, NF_param, obs_param, NF_names, obs_names, x, z, args, mode='train'):
    # load params into the network
    load_weights(NF, NF_names, NF_param, as_params=False, device=x.device)
    load_weights(obstacle, obs_names, obs_param, as_params=False, device=x.device)
